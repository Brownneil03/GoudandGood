        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white tracking-tight">
                  Goud<span className="text-emerald-400">&</span>Good
                </span>
                <span className="text-xs text-slate-500 font-medium">
                  Guide Tech #1 au Maroc
                </span>
              </div>
            </Link>
            <p className="mt-6 text-slate-400 max-w-md leading-relaxed">
              Votre guide d'achat tech au Maroc. Des comparatifs honnêtes,
              des recommandations personnalisées et des prix en Dirhams pour
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a
                href="https://tiktok.com/@goudandgood"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-slate-800 hover:bg-black text-slate-400 hover:text-white flex items-center justify-center transition-all duration-300"
                aria-label="TikTok"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Categories */}
          <div>
            <h3 className="text-white font-bold text-lg mb-6">Catégories</h3>
            <ul className="space-y-4">
              <li>
                ...
                >
                  <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full opacity-0 group-hover:opacity-100" />
                  Smartphones
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">
              © {currentYear} Goud&Good. Tous droits réservés.
            </p>
            <p className="text-slate-600 text-xs text-center md:text-right max-w-md">
              Les prix affichés peuvent varier. Certains liens sont des liens
              d'affiliation qui nous permettent de financer ce site.
            </p>
          </div>
        </div>
      </div>
